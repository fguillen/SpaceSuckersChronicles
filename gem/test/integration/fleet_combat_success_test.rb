...
class FleetCombatSuccessTest < Test::Unit::TestCase
  ...
  def test_combat
    ...
    assert_equal( 8,      @ship2.life )
    assert_equal( 8,      @ship3.life )
    assert_equal( 4,      @ship4.life )
    assert_equal( 4,      @ship5.life )
    ...
    assert_equal( true,   @universe.units.include?( @ship5 ) )
    assert_equal( false,  @planet2.units.include?( @ship4 ) )
    assert_equal( true,   @planet2.units.include?( @ship5 ) )
    assert_equal( true,   @universe.fleets.include?( @fleet ) )
    assert_equal( 10,      @ship1.life )
    ...
    assert_equal( false,  @planet2.units.include?( @ship4 ) )
    assert_equal( false,  @planet2.units.include?( @ship5 ) )
    assert_equal( true,   @universe.fleets.include?( @fleet ) )
    assert_equal( 10,     @ship1.life )
    assert_equal( -1,     @ship2.life )
    ...
    assert_equal( false,  @planet2.units.include?( @ship4 ) )
    assert_equal( false,  @planet2.units.include?( @ship5 ) )
    assert_equal( true,   @planet2.units.include?( @ship3 ) )
