...
class UtilsTest < Test::Unit::TestCase
  ...
  def test_planet_distance
    planet1 = S2C::Models::Units::Planet.new( :position => [0,0] )
    planet2 = S2C::Models::Units::Planet.new( :position => [0,0] )
    assert_equal( 0, S2C::Utils.planet_distance( planet1, planet2 ) )

    planet1 = S2C::Models::Units::Planet.new( :position => [0,0] )
    planet2 = S2C::Models::Units::Planet.new( :position => [1,1] )
    assert_equal( 1, S2C::Utils.planet_distance( planet1, planet2 ) )

    planet1 = S2C::Models::Units::Planet.new( :position => [0,0] )
    planet2 = S2C::Models::Units::Planet.new( :position => [5,5] )
    assert_equal( 7, S2C::Utils.planet_distance( planet1, planet2 ) )

    planet1 = S2C::Models::Units::Planet.new( :position => [0,0] )
    planet2 = S2C::Models::Units::Planet.new( :position => [5,10] )
    assert_equal( 11, S2C::Utils.planet_distance( planet1, planet2 ) )

    planet1 = S2C::Models::Units::Planet.new( :position => [10,5] )
    planet2 = S2C::Models::Units::Planet.new( :position => [0,0] )
    assert_equal( 11, S2C::Utils.planet_distance( planet1, planet2 ) )
  end
